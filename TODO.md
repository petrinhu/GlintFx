...
- **Guard de escrita do `TODO.md` (`P4`, hardcoded 9 colunas, sem válvula):** `~/.claude/hooks/lider_bloqueios/p4.py`. Motivo de esta tabela usar o schema canônico da skill em vez do desenho original de 10 colunas com WSJF embutido: decisão do líder, tomada ao ver o conflito com este guard (registrado abaixo).
