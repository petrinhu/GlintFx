...
4. **Ruído do diagnóstico `property_reserved`** para quem escreve folha antes da 1.0: sem consumidor externo hoje, não há como medir incômodo; se incomodar, o remédio é um nível de severidade "aviso" no tipo de diagnóstico, que já é campo dele — não muda o registro (E1).
