...
| ⚖ | tocar folha de estilo, tema, layout de UI ou parser de estilo | L-28 o formato é o **`gfss`**, implementado em casa, sem RmlUi; **layout entra**, marcação **`gfml`** decidida mas não aberta |
