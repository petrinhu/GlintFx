...
**On Windows**, the test suite currently has 106 registered cases in shared mode and 106 in static mode. The two modes match because the Windows counterpart of that pair (`exports_win_test`/`exports_win_selftest`) is not gated off in static mode.
