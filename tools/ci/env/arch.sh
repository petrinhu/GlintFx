...
# "Arch - compartilhado/estatico") - mesmos pacotes, mesma ordem, so' o
# LOCAL mudou. GODS_LAWS.md L-04: CachyOS NAO reaproveita este script -
# imagem, repositorios e toolchain proprios, script proprio
# (cachyos.sh).
#
