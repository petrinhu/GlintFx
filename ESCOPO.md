...
**O que ainda NÃO está provado, declarado e não escondido:** que nenhum símbolo exportado muda de nome. O Itanium não codifica especificação de exceção no *mangling*, o que cobre os quatro alvos de Linux; **o Windows ainda tem de ser conferido**, e isso é fatia própria do plano, não suposição.
